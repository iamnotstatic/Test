                    ...
                    <div class="col-md-4">
                            ...
                            @if(Auth::user()->hasAnyRole('staff'))
                                <div class="card card-body">
                                    ...
                                    <li class="list-group-item">
                                        <a href="/staff/departments" style="text-decoration: none">All Departments</a>
                                    </li>
                                    <li class="list-group-item">
                                        <a href="/staff/dashboard" style="text-decoration: none">Profile</a>
                                    </li>
                                    </ul>
                                </div>
                            @endif
                       ...
                       @if(Auth::user()->hasAnyRole('admin'))
                           <div class="card card-body">
                            <ul class="list-group">
                               <li class="list-group-item">
                                   <a href="{{route('admin.create.department')}}" style="text-decoration: none">Create Department</a>
                               </li>
                               <li class="list-group-item">
